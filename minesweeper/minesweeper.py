...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Check if one of the sentences in the AI's KB, is a safe or a mine cell
        ...
        # Check if any of the sentences are a subset of anohter sentence to infer new sentences from them
        for first_sentence in self.knowledge:
            for second_sentence in self.knowledge:
                ...
                elif first_sentence.cells.issubset(second_sentence.cells):
                    new_sentence = Sentence(
                        second_sentence.cells - first_sentence.cells, second_sentence.count - first_sentence.count)
